...
class MbdDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        return self.transforms(self.image_files1[index]), self.labels[index], self.params[index,:] # self.transforms(self.image_files2[index]), self.transforms(self.image_files3[index]), self.transforms(self.image_files4[index]), self.labels[index], self.params[index,:]
